...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>R & R Auto Care | Forget Password</title>
    ...
    <body class="account-pages">
        ...
        <!-- Begin page -->
        <div class="accountbg" style="background: url('lastone/assets/images/picture1.jpg');background-size: cover;background-position: center;"></div>
                    ...
                    <div class="account-box">
                        ...
                        <div class="card-box p-5">
                            <h3 class="text-uppercase text-center pb-4">
                                <a href="../index.php">
                                    <span> R & R Auto Care  | Recover Password</span>
                                </a>
                            </h3>
                          <hr color="#000" />
