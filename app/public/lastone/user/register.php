...
if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
    $password=md5($_POST['password']); //data encrypting with using md5
...
return true;
    ...
    <body class="account-pages">
        ...
        <!-- Begin page -->
        <div class="accountbg" style="background: url('../lastone/assets/images/signupbackground.jpg');background-position: center;"></div>
                    ...
                    <div class="account-box">
                        ...
                        <div class="card-box p-5">
                            <h3 class="text-uppercase text-center pb-4">
                                    ...
                                    <span>R & R Auto Care | Sign Up</span>
                            ...
                            <form class="form-horizontal" action="" name="signup" method="post" onsubmit="return checkpass();">
                                ...
                                <div class="form-group row m-b-20">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" type="email" id="email" name="email" required="" placeholder="your email @gmail.com">
                                    </div>
                                </div>
